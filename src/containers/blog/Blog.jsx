...
const Blog = () => {
  return (
    <div className="alpha_blog section_padding" id="blog">
    <div className="alpha_blog-heading">
      <h1 className="gradient_text">A lot is happening, <br /> We are blogging about it.</h1>
    </div>
    <div className="alpha_blog-container">
      <div className="alpha_blog-container_groupA">
        <Article imgUrl={blog01} date="Sep 26, 2021" text="GPT-3 and Open  AI is the future. Let us exlore how it is?" />
      </div>
      <div className="alpha_blog-container_groupB">
